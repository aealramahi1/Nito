...
class RoundCreator(commands.Cog):
    ...
    Commands:
        q!load_rounds: Loads round information
    ...
    async def makeRound(self, gid, cid, newrnd):
        """
        Creates a new round and handles the case where the guild is not present in the allRounds dictionary
    ...
    async def join(self, ctx):
        ...
        def correctUser(context):
            """
            Makes sure that the user is round_owner and is messaging in the correct channel
